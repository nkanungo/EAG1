...
@mcp.tool()
async def write_to_paint(note_for_paint: str) -> Dict:
    """Open Windows Paint and then write in the Paint"""
    try:
        # Start Paint
        ...
        # Move to and click on the text tool (coordinates may vary based on screen resolution)
        pyautogui.moveTo(423, 107)  # Example coordinates of the text tool icon
        pyautogui.click()
        time.sleep(1)
        # pyautogui.press('r')
        # time.sleep(1)
        ...
        # Type the text
        pyautogui.write(note_for_paint)
        time.sleep(0.5)
        ...
        return {
            "content": [
                TextContent(
                    type="text",
                    text="Paint opened successfully and text added successfully."
                )
            ]
        }
        ...
        return {
            "content": [
                TextContent(
                    type="text",
                    text=f"Error opening and writing to Paint: {str(e)}"
                )
            ]
        }
