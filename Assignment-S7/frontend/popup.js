...
showStatsBtn.addEventListener('click', () => {
  ...
  fetch(`${BACKEND_BASE}/api/indexed_pages`)
    .then(res => res.json())
    .then(data => {
      if (data.success && data.stats) {
          ...
          <div style="padding:10px 0 0 0;">
            ...
            <table style="width:100%;border-collapse:separate;border-spacing:0 6px;margin-top:10px;">
              <tr>
                ...
                <td style="color:#0078d7;font-weight:bold;text-align:right;">${data.stats.total_pages}</td>
              </tr>
              <tr>
                <td style="font-weight:500;color:#333;">Total Chunks</td>
                <td style="color:#0078d7;font-weight:bold;text-align:right;">${data.stats.total_chunks}</td>
              </tr>
            </table>
        ...
        statsContent.innerHTML = '<div style="color:red;padding:10px;">Error loading stats</div>';
      }
    })
    .catch(error => {
